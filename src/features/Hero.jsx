...
import myImage2 from "../assets/myNewImage.jpeg";
...
const Hero = () => {
  ...
  return (
    <main className="">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center py-8 container mx-auto lg:pb-12 pt-20 border-b border-[#C7C7C7] md:mt-10">
        ...
        <section className="mt-8 lg:mt-0 flex justify-center md:justify-start lg:justify-end">
          <img
            className="w-full rounded-2xl  h-[500px] md:w-[550px] md:h-[650px] object-cover"
            src={myImage2}
            alt="Hero"
          />
        </section>
